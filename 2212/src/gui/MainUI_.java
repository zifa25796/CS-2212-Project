...
public class MainUI_ extends JFrame implements ActionListener {
    /**
     *
     */
    private static final long serialVersionUID = 1L;

    private static MainUI_ instance;
    ...
    public static MainUI_ getInstance() {
        if (instance == null)
            instance = new MainUI_();
...
//		getContentPane().add(west, BorderLayout.WEST);
    ...
    public void display() {
        JFrame frame = MainUI_.getInstance();
