...
public class StrategyD implements StrategyADT{
    ...
    /**
     * A static variable representing the one and only StrategyD instance
     */
    private static StrategyD instance;
    /**
    ...
    /**
     * Getter method for StrategyD's instance
     * @return instance
     */
    public static StrategyD getInstance() {
        // If instance was not created, create one
        if (instance == null)
            instance = new StrategyD();

        return instance;
    }

    /**
     * {@link StrategyD} class initializer
     */
    private StrategyD() {
        counter = 0;
    }
    ...
    public TradeResult performRule(String traderName, HashMap coinPriceList) {
        ...
        if (checkNecessary(coinPriceList)) {
            ...
            if (compute(coinPriceList)) {
                ...
                return new TradeResult(traderName, "Strategy-D", "ETH", "Buy", 60, 12.34, getDate("dd-MMM-YYYY"));
            }
        } else {
            ...
            return new TradeResult(traderName, "Strategy-D", "", "Fail", -1, -1, getDate("dd-MMM-YYYY"));
        }
        return null;
    }
